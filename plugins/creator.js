...
❑ *Ulang Tahun* : 28 DESEMBER 2003
❑ *Alamat* : Indonesia, BOYOLALI, JAWA TENGAH 
...
const sections = [
   {
	title: `${htjava} OWNER –––––––––·•`,
	rows: [
	    {title: "📱 • Nomor ᴹᴿ᭄ PRATAMAOffcོ_3ঔৣ꧂", rowId: ".owner nomor"},
	{title: "🎨 • Biodata ᴹᴿ᭄ PRATAMAOffcོ_3ঔৣ꧂", rowId: ".owner bio"},
